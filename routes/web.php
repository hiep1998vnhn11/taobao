...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('item/{item}/delete', [OrderController::class, 'delete'])->name('item.delete');
...
Route::get('/orders', [DetailController::class, 'index'])->name('details.index');
Route::post('/create_detail', [DetailController::class, 'create'])->name('details.create');
Route::get('/order/{order}', [DetailController::class, 'show'])->name('details.show');
...
Route::group(['middleware' => ['auth', 'isadmin']], function () {
    ...
    Route::get('/status1/{order}', [DashboardController::class, 'updateStatus1'])->name('updateStatus1');
    Route::get('/status2/{order}', [DashboardController::class, 'updateStatus2'])->name('updateStatus2');
    Route::get('/status3/{order}', [DashboardController::class, 'updateStatus3'])->name('updateStatus3');
});
