            ...
            <div class="span12">
                <div class="account pull-right">
                    <ul class="user-menu">
                        ...
                        <li><a href="{{ url('/orders') }}">Danh Sách Đặt Hàng</a></li>
                        @else
                        <li><a href="{{ url('/login') }}">Giỏ Hàng</a></li>
                        <li><a href="{{ url('/login') }}">Thanh Toán</a></li>
                        <li><a href="{{ url('/login') }}">Danh Sách Đặt Hàng</a></li>
                        @endif
                        @guest
                        @if (Route::has('login'))
                        ...
                        <li class="nav-item dropdown">
                            <a id="navbarDropdown" class="logged_name nav-link dropdown-toggle" href="{{ route('logout') }}" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre onclick="event.preventDefault();
